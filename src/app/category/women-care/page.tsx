...
export default function WomenCareProductsPage() {
  ...
  return (
    <div className="space-y-6"> 
      <section className="text-center py-6 bg-gradient-to-r from-pink-100 via-purple-50 to-background rounded-xl shadow-md"> 
        <HeartHandshake size={36} className="mx-auto text-pink-500 mb-3" /> 
