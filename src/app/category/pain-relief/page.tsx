...
export default function PainReliefProductsPage() {
  ...
  return (
    <div className="space-y-6"> 
      <section className="text-center py-6 bg-gradient-to-r from-red-100 via-orange-50 to-background rounded-xl shadow-md"> 
        <Bandage size={36} className="mx-auto text-red-500 mb-3" /> 
