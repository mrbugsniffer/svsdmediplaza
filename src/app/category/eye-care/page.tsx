...
import { Package, Eye } from 'lucide-react'; // Using Eye as a representative icon

export default function EyeCareProductsPage() {
  ...
  return (
    <div className="space-y-6"> {/* Reduced overall vertical spacing */}
      <section className="text-center py-6 bg-gradient-to-r from-blue-100 via-sky-50 to-background rounded-xl shadow-md"> {/* Reduced vertical padding */}
        <Eye size={36} className="mx-auto text-blue-500 mb-3" /> {/* Reduced icon size and margin */}
        ...
        <p className="text-sm text-muted-foreground mt-2"> {/* Reduced paragraph text size */}
          Discover products for your eye health and vision care.
        </p>
      </section>
