...
export default function ColdAndFluProductsPage() {
  ...
  return (
    <div className="space-y-6"> 
      <section className="text-center py-6 bg-gradient-to-r from-blue-100 via-cyan-50 to-background rounded-xl shadow-md"> 
        <ShieldCheck size={36} className="mx-auto text-blue-500 mb-3" /> 
