  ...
  return (
    <div className="space-y-6"> {/* Reduced overall vertical spacing */}
      <section className="text-center py-6 bg-gradient-to-r from-accent/20 via-secondary/10 to-background rounded-xl shadow-md"> {/* Reduced vertical padding */}
        <FlaskConical size={36} className="mx-auto text-primary mb-3" /> {/* Reduced icon size and margin */}
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3"> {/* Adjusted skeleton to match 5 cols, reduced grid gap */}
