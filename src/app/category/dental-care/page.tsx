...
export default function DentalCareProductsPage() {
  ...
  return (
    <div className="space-y-8">
      <section className="text-center py-8 bg-gradient-to-r from-sky-100 via-blue-50 to-background rounded-xl shadow-md">
        <Smile size={48} className="mx-auto text-sky-600 mb-4" />
