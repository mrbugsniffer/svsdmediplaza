...
export default function DentalCareProductsPage() {
  ...
  return (
    <div className="space-y-6"> {/* Reduced overall vertical spacing */}
      <section className="text-center py-6 bg-gradient-to-r from-sky-100 via-blue-50 to-background rounded-xl shadow-md"> {/* Reduced vertical padding */}
        <Smile size={36} className="mx-auto text-sky-600 mb-3" /> {/* Reduced icon size and margin */}
